...
class SettingsDialog(QDialog):
    def __init__(self, settings: dict[str, str], parent=None):
        ...
        self.approver_signature_path = QLineEdit(settings.get("approver_signature_image_path", ""))
        ...
        form_layout.addRow("Approver Signature Image Path", self._row_with_picker(self.approver_signature_path, file_mode=True))
    ...
    def to_dict(self) -> dict[str, str]:
        return {
            ...
            "approver_signature_image_path": self.approver_signature_path.text().strip(),
